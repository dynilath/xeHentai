...
TASK_TITLE = "task #{}(gid={}) title {}"
TASK_WILL_DOWNLOAD_CNT = "task #%s will download %d/%d files"
TASK_START = "task #%s start"
TASK_FINISHED = "task #{}(gid={}) download finishd"
TASK_START_PAGE_RESCAN = "task #%s resample detected, start full scan"
# TASK_FAST_SCAN = "task #%s uses fast scan"
TASK_START_MAKE_ARCHIVE = "task #{}(gid={}) start making archive"
TASK_MAKE_ARCHIVE_FINISHED = "task #{}(gid={}) archive saved at: {}, use {:.1f}s"
...
DF_STATE_START_SCAN_PAGE = "task #{}(gid={}) start scanning pages"
