...
DF_MIGRATE_NEW_VERSION = "[guid={guid} gid={gid}] newer gallery version detected, task marked as has-new-version, new task url: {url}"
DF_MIGRATE_NEW_VERSION_FAIL = "[guid={guid} gid={gid}] newer gallery version detected, task marked as has-new-version, but adding the new task failed [result={ret}] url: {url}"
...
SUB_TASK_ADDED = "[sub id={sid} gid={gid}] task created for subscribed gallery [guid={guid}]: {url}"
SUB_TASK_ADD_FAIL = "[sub id={sid} gid={gid}] failed to create task for subscribed gallery [ret={ret}]: {url}"
